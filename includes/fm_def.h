...
#define FM_RSA_MAX_BITS_4096     4096
#define FM_RSA_MAX_LEN_4096      512
#define FM_RSA_MAX_PLEN_4096     256
...
typedef struct tagRSAPublicKeySt_4096
{
     FM_U32 bits;                      /* modulus bit length */
     FM_U8 m[FM_RSA_MAX_LEN_4096];          /* modulus N, N=P*Q */
     FM_U8 e[FM_RSA_MAX_LEN_4096];          /* public exponent E */
}FM_RSA_PublicKey_4096, *PFM_RSA_PublicKey_4096;

/* private Key size=1412byte */
typedef struct tagRSAPrivateKeySt_4096
{
     FM_U32 bits;                      /* modulus bit length */
     FM_U8 m[FM_RSA_MAX_LEN_4096];          /* modulus N, N=P*Q */
     FM_U8 e[FM_RSA_MAX_LEN_4096];          /* public exponent E */
     FM_U8 d[FM_RSA_MAX_LEN_4096];          /* private exponent D, D=(E^-1)mod(P-1)(Q-1), now not use */
     FM_U8 prime[2][FM_RSA_MAX_PLEN_4096];  /* prime P and Q, P>Q */
     FM_U8 pexp[2][FM_RSA_MAX_PLEN_4096];   /* Dp,Dq, Dp=D mod(P-1),Dq=D mod(Q-1) */
     FM_U8 coef[FM_RSA_MAX_PLEN_4096];      /* Q^-1 mod P  */
}FM_RSA_PrivateKey_4096, *PFM_RSA_PrivateKey_4096;
