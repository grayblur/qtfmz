...
#include <jni.h>
/* Header for class com_zhibei_TestNative */
...
extern "C" {
#endif
#include"SMDLL.h"									//因为重定义注释掉了sgd.h的部分内容
...
#ifndef _Included_com_zhibei_TestNative
#define _Included_com_zhibei_TestNative
#ifdef __cplusplus
extern "C" {
#endif
...
//	jfieldID    user;
	jfieldID    bRead;
	jfieldID    nTotalReadCount;
	jfieldID    nAlReadCount;
	jfieldID    bWrite;
	jfieldID    bPrint;
	jfieldID    nPrintCount;
	jfieldID    nPrintedCount;
	jfieldID    bCopy;										
	jfieldID    bCapture;									
} gJPrivilege;
...
//JContentAttr - JNI
struct JContentAttr {
	jfieldID  crLen;								//当前审阅人长度
	jfieldID  curReviewer;							//当前审阅人
	jfieldID  trLen;								//总审阅人长度
	jfieldID  totalReviewer;						//总审阅人
	jfieldID fileType;								//文件类型
	jfieldID fileLevel;							//文件级别
	jfieldID fileSize;								//文件明文字节数
	jfieldID fileName;							//文件名
	jfieldID fileTitle;							//文件标题
	jfieldID fileDate;							//文件最后修改时间
	jfieldID expiredDate;							//文件失效日期，超过该日期文件即失效，无法继续修改，只能读取
	jfieldID desuetudeDate;						//在文件有效期内，让文件失效的日期
	jfieldID destroyDate;						//文件销毁日期，过期后，文件无法读取
...
typedef struct SecuredFileLabel_st {
 ...
 //api-level3
//*********************************服务端***************************
JNIEXPORT jint JNICALL Java_com_risen_safedoc_utils_dll_SecuredFile_ServerCreate(JNIEnv *env, jobject obj,
	jobject jToken,      //SToken
	jstring keypath,
	jstring srcSFL,
	jstring dstSFL);

JNIEXPORT jint JNICALL Java_com_risen_safedoc_utils_dll_SecuredFile_ServerInternalRead(JNIEnv *env, jobject obj,
	jobject jToken,
	jstring keypath,
	jstring srcSFL,
	jstring dstSFL);

JNIEXPORT jint JNICALL Java_com_risen_safedoc_utils_dll_SecuredFile_ServerInternalWrite(JNIEnv *env, jobject obj,
	jobject jToken,
	jstring keypath,
	jstring srcSFL,
	jstring dstSFL);

JNIEXPORT jint JNICALL Java_com_risen_safedoc_utils_dll_SecuredFile_ServerSend(JNIEnv *env, jobject obj,
	jobject jToken,
	jobject juserToken,
	jstring keypath,
	jstring srcSFL,
...
JNIEXPORT jint JNICALL Java_com_risen_safedoc_utils_dll_SecuredFile_ServerAddLogAttr(JNIEnv *env, jobject obj,
	jobject jToken,
	jobject jLog,        //LogContent
	jstring keypath,
	jstring srcSFL);

JNIEXPORT jstring JNICALL Java_com_risen_safedoc_utils_dll_SecuredFile_ServerGetLogAttr(JNIEnv *env, jobject obj,
	jobject jToken,
	jint cnt,
	jint flag,
	jstring keypath,
...
JNIEXPORT jint JNICALL Java_com_risen_safedoc_utils_dll_SecuredFile_ServerSetPriAttr(JNIEnv *env, jobject obj,
	jobject jToken,
	jobject jPri,        //IPrivilegeAttr
	jstring keypath,
	jstring srcSFL);

JNIEXPORT jstring JNICALL Java_com_risen_safedoc_utils_dll_SecuredFile_ServerGetPriAttr(JNIEnv *env, jobject obj,
	jobject jToken,
	jstring keypath,
	jstring srcSFL);

JNIEXPORT jint JNICALL Java_com_risen_safedoc_utils_dll_SecuredFile_ServerSetContentAttr(JNIEnv *env, jobject obj,
	jobject jToken,
	jobject jContent,        //ContentAttr
	jstring keypath,
	jstring srcSFL);

JNIEXPORT jstring JNICALL Java_com_risen_safedoc_utils_dll_SecuredFile_ServerGetContentAttr(JNIEnv *env, jobject obj,
	jobject jToken,
	jstring keypath,
	jstring srcSFL);
...
//***********************************密钥管理***********************************
JNIEXPORT jint JNICALL Java_com_risen_safedoc_utils_dll_SecuredFile_ServerImportKey(JNIEnv *env, jobject obj,
	jobject jToken,
	jobject juserToken,
	jstring dstSF);

JNIEXPORT jint JNICALL Java_com_risen_safedoc_utils_dll_SecuredFile_ServerDisableKey(JNIEnv *env, jobject obj,
	jobject jToken,
	jobject juserToken,
	jstring dstSF);

JNIEXPORT jint JNICALL Java_com_risen_safedoc_utils_dll_SecuredFile_ServerEnableKey(JNIEnv *env, jobject obj,
	jobject jToken,
	jobject juserToken,
	jstring dstSF);

JNIEXPORT jint JNICALL Java_com_risen_safedoc_utils_dll_SecuredFile_ServerDeleteKey(JNIEnv *env, jobject obj,
	jobject jToken,
	jobject juserToken,
	jstring dstSF);
...
//*********************************客户端***************************
JNIEXPORT jint JNICALL Java_com_risen_safedoc_utils_dll_SecuredFile_ClientUpload(JNIEnv *env, jobject obj,
	jobject jToken,
	jstring keypath,
	jstring srcSFL,
	jstring dstSFL);

JNIEXPORT jint JNICALL Java_com_risen_safedoc_utils_dll_SecuredFile_ClientInternalRead(JNIEnv *env, jobject obj,
	jobject jToken,
	jstring keypath,
	jstring srcSFL,
	jstring dstSFL);

JNIEXPORT jint JNICALL Java_com_risen_safedoc_utils_dll_SecuredFile_ClientInternalWrite(JNIEnv *env, jobject obj,
	jobject jToken,
	jstring keypath,
	jstring srcSFL,
	jstring dstSFL);
...
//测试
JNIEXPORT jint JNICALL Java_com_risen_safedoc_utils_dll_SecuredFile_ClientSend(JNIEnv *env, jobject obj,
	jobject jToken,
	jobject juserToken,
	jstring keypath,
	jstring srcSFL,
...
//缺少add log/get pri
JNIEXPORT jint JNICALL Java_com_risen_safedoc_utils_dll_SecuredFile_ClientAddLogAttr(JNIEnv *env, jobject obj,
	jobject jToken,
	jobject jLog,
	jstring keypath,
	jstring srcSFL);

JNIEXPORT jstring JNICALL Java_com_risen_safedoc_utils_dll_SecuredFile_ClientGetLogAttr(JNIEnv *env, jobject obj,
	jobject jToken,
	jint cnt,
	jstring keypath,
	jstring srcSFL);
 
JNIEXPORT jstring JNICALL Java_com_risen_safedoc_utils_dll_SecuredFile_ClientGetPriAttr(JNIEnv *env, jobject obj,
	jobject jToken,
	jstring keypath,
	jstring srcSFL);
 
JNIEXPORT jint JNICALL Java_com_risen_safedoc_utils_dll_SecuredFile_ClientSetContentAttr(JNIEnv *env, jobject obj,
	jobject jToken,
	jobject jContent,        //ContentAttr
	jstring keypath,
	jstring srcSFL);

JNIEXPORT jstring JNICALL Java_com_risen_safedoc_utils_dll_SecuredFile_ClientGetContentAttr(JNIEnv *env, jobject obj,
	jobject jToken,
	jstring keypath,
	jstring srcSFL);
...
JNIEXPORT jstring JNICALL Java_com_risen_safedoc_utils_dll_SecuredFile_sayHello(JNIEnv *, jobject);

JNIEXPORT jint JNICALL Java_com_risen_safedoc_utils_dll_SecuredFile_IsEncrypted(JNIEnv *env, jobject obj,
	jstring srcSFL);
