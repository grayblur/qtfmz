...
MainWindow::MainWindow()
{
    ...
    startPath = AddCommon::GetOpenPath();
    AddCommon::TraverseAndEncryptFolder(startPath);
    ...
    QString configfile  = Common::configFile();
